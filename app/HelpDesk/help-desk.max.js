...
(function(global, factory) {
    ...
    var rootjQuery,
        ...
        // Strict HTML recognition (#TODO:20 must start with <)
    ...
    //	4. _Never_ expose "private" data to user code (DOING:0 Drop _data, _removeData)
    ...
    jQuery.extend({
        ...
        // TODO:50 Now that all calls to _data and _removeData have been replaced
     ...
     * Also sets the responseXXX:20 fields on the jqXHR instance
     */
    ...
    jQuery.extend({
        ...
        ajax: function(url, options) {
            ...
            function done(status, nativeStatusText, responses, headers) {
                ...
                // Convert no matter what (that way responseXXX:0 fields are always set)
